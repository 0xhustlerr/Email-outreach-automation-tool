...
export default function ReplyToast({ title, description, onOpen }: Props) {
  return (
    <button
      type="button"
      onClick={onOpen}
      className="flex w-full min-w-[280px] max-w-sm flex-col gap-1 rounded-xl border border-emerald-500/35 bg-slate-950/95 px-4 py-3 text-left shadow-lg backdrop-blur-md transition hover:border-emerald-400/50"
    >
